...
3. Не выдумывай цифры, отзывы, кейсы, даты выхода функций — если не уверен, пиши обобщённо. Если в задании
   дан реальный новостной источник — используй ТОЛЬКО факты из его заголовка/описания, ничего не домысливай
   об этом событии; упоминай источник по названию в тексте (например «как сообщает DJ Mag»), но НЕ делай
   его ссылкой — ссылки только на сайт продвигаемого сервиса.
